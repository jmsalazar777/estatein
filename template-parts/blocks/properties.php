                    ...
                    ?>
                        ...
                        <div class="swiper-slide">
                            ...
                            <div class="content-wrapper">
                                ...
                                <div class="extra-field-wrapper flex">
                                    <?php if ($bedroom): ?>
                                        <div class="item icon icon-before bed-front">
                                            <?= $bedroom ?>-Bedroom
                                        </div>
                                    <?php endif; ?>
                                    <?php if ($bathroom): ?>
                                        <div class="item icon icon-before bath">
                                            <?= $bathroom ?>-Bathroom
                                        </div>
                                    <?php endif; ?>
                                    <?php if ($unit_type): ?>
                                        <div class="item icon icon-before building">
                                            <?= $unit_type ?>
                                        </div>
                                    <?php endif; ?>
                                </div>
